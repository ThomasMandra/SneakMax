...
DG.then(function () {
  ...
  DG.marker([54.99, 82.89]).addTo(map);
  DG.marker([54.99, 82.91]).addTo(map);
});
      ...
      <div className={styles.contactsInfo}>
        ...
        <ul>
          <li className={styles.contactsItem}>
            <div className={styles.contactsItemHelp}>
              <h4>ГЛАВНЫЙ ОФИС</h4>
              <div>
            ...
            <address>
              <Link to={"tel:+79991112233"}>+7 800 789 89 89</Link>
